...
const InstituteLogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    setTimeout(() => {
      ...
      console.log('Institute Login payload:', { email, password })
  ...
  return (
    <div className="min-h-[80vh] flex bg-gray-50">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-600 to-cyan-600 text-white flex-col justify-center items-center p-12">
        <div className="text-center">
          ...
          <p className="text-2xl text-blue-100 mb-4">Event Aggregator - Institute Portal</p>
          <p className="text-blue-100 text-lg leading-relaxed max-w-md">
            Manage college events, reach your student community, and create unforgettable experiences. Connect with thousands of engaged students.
          </p>
          ...
          <div className="mt-12 space-y-4 text-base">
            ...
            <div className="flex items-center gap-3">
              ...
              <span>Reach your community</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-6 py-12 md:px-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-600 mb-8">Enter your credentials to access your institution account</p>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="admin@yourcollegge.edu"
              />
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 text-sm">
              ...
              <Link to="/register/college" className="font-semibold text-blue-600 hover:text-blue-700">
